...
import { LinkGroup, LinksGroupedByType, LinksOptions } from "@/types/TypeLinks";
  ...
  async function onSubmit(data: z.infer<typeof LinkFormSchema>) {
    ...
    try {
      ...
      const payload = {
        ...
        broker_id,
        entity_type_id: data.is_master ? null : account_type_id,
        url_type: data.type,
        name: data.name,
        url: data.url,
            ...
            <div className="flex items-center justify-between">
              ...
              {can_manage && (
                <Button
                  ...
                  title="Add link"
                  className={cn(
                    "mr-4 h-7 w-7 shrink-0 rounded-md transition-all duration-150 ring-1 ring-inset",
