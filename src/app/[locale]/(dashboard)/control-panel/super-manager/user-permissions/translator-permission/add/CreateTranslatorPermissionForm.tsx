...
interface CreateTranslatorPermissionFormProps {
  platformUsers: Array<{ id: number; name: string; email: string }>;
  countries: Array<{ id: number; name: string; country_code: string }>;
}

export function CreateTranslatorPermissionForm({ platformUsers, countries }: CreateTranslatorPermissionFormProps) {
  ...
  return (
    <Card className="p-4 sm:p-6">
      <h2 className="text-lg font-semibold mb-4">Create Translator Country Permission</h2>
