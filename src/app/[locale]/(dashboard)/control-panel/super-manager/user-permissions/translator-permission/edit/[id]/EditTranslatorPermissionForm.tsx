...
const schema = z.object({
  ...
  permission_type: z.literal('translator'),
...
interface EditTranslatorPermissionFormProps {
  permission: any;
  platformUsers: Array<{ id: number; name: string; email: string }>;
  countries: Array<{ id: number; name: string; country_code: string }>;
}

export function EditTranslatorPermissionForm({ permission, platformUsers, countries }: EditTranslatorPermissionFormProps) {
  ...
  return (
    <Card className="p-4 sm:p-6">
      <h2 className="text-lg font-semibold mb-4">Edit Translator Country Permission</h2>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div className="space-y-2">
            ...
            <Input value="TRANSLATOR" disabled />
          </div>
          <div className="space-y-2">
