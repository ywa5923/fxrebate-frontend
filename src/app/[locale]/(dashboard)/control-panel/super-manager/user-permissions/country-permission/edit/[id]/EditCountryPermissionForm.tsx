...
const schema = z.object({
  ...
  permission_type: z.literal('country'),
...
interface EditCountryPermissionFormProps {
  permission: any;
  platformUsers: Array<{ id: number; name: string; email: string }>;
  countries: Array<{ id: number; name: string; country_code: string }>;
}

export function EditCountryPermissionForm({ permission, platformUsers, countries }: EditCountryPermissionFormProps) {
  ...
  return (
    <Card className="p-4 sm:p-6">
      <h2 className="text-lg font-semibold mb-4">Edit Country Type Permission</h2>
