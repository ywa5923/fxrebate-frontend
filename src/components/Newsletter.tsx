        ...
        <InViewContainer amount={0.2} className="md-custom-container">
            <motion.div
                ...
                <div className="w-full md:w-[55%] ">
                    <h2 className="section-title md:!text-left !text-white">Newsletter</h2>
                    <p className="!font-roboto text-center text-white md:text-left mt-6 text-lg leading-7">
                        You might be losing opportunities, but it&apos;s OK. If you need to learn more about how
                        FXRebate works and how to make your activity more profitable, sign up here to receive the latest
                        information about our partners, to increase your revenue.
                    </p>
                </div>
                <div className="w-full md:w-[45%]">
                    <form className="flex flex-col gap-4 text-white text-sm font-medium placeholder:text-white">
                        <div className="flex flex-col gap-2">
                            <label className="!font-inter block mt-1.5">Name</label>
                            <input
